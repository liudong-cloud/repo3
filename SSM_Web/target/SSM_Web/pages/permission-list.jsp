                            ...
                            <c:forEach items="${permissionList}" var="p">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="javascript:void(0)" onclick="aa('${p.id}')"
...
<script>
    ...
    function aa(id) {
        $.ajax({
            ...
            success: function (permissionList1) {
                var tt = "";
                for (var i = 0; i < permissionList1.length; i++) {
                    var p = permissionList1[i];
                    tt += '<tr>\n' +
                        '  <td><input name="ids" type="checkbox"></td>\n' +
                        '      <td>' + p.id + '</td>\n' +
                        '      <td>' + p.permissionName + '</td>\n' +
                        ...
                        '      <a href="javascript:void(0)" onclick="aa(\'' + p.id + '\')" class="btn bg-olive btn-xs">删除权限</a>\n' +
                        '  </td> \n' +
                        '\t\t\t\t\t\t\t</tr>'
                }
                $("#tbody").html(tt);
